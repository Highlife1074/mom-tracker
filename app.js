    ...
    {!sc
      ...
      :<div>
        ...
        {critPath&&<div className="sched-noprint" style={{padding:"9px 12px",background:"#fdf1e0",border:"1.5px solid #e6c48c",borderRadius:8,marginBottom:10,display:"flex",gap:10,alignItems:"center",flexWrap:"wrap"}}>
          ...
          <button className="btn btn-sm" onClick={function(){setCritPath(null);}}>✕ Hide</button>
        </div>}
        ...
        <div className="sched-noprint" style={{display:"flex",gap:10,alignItems:"center",marginBottom:8,flexWrap:"wrap"}}>
          ...
          <button className={"btn btn-sm"+(critPath?" btn-pri":"")}
            ...
            onClick={function(){
              ...
              setCritPath(cp);
            }} style={{padding:"2px 8px",fontSize:10}}>🎯 Critical path</button>
            ...
            <tbody>
              ...
              {visibleRows.map(function(row){
                ...
                <tr style={{background:isSection?"#2b2e36":isCat?"#f0ede6":"#fff"}}>
                  <td style={{position:"sticky",left:0,zIndex:1,background:focusRow===row.id?"#fff8e1":isSel?"#e8f0fe":isSection?"var(--ink,#16181d)":isCat?"#f0ede6":"#fff",padding:isSection?"5px 10px":"3px 10px",borderBottom:isSection?"1.5px solid var(--ink,#16181d)":"1px solid #f5f4f0",borderRight:"1.5px solid #e8e6df",boxShadow:focusRow===row.id?"inset 3px 0 0 #f57f17":onCrit?"inset 3px 0 0 var(--amber,#b35c00)":"none"}}>
