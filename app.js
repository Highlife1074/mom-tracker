      ...
      :<div>
          ...
          <table style={{borderCollapse:"collapse",width:"max-content",minWidth:"100%",fontSize:11}}>
            ...
            <tbody>
              ...
              {visibleRows.map(function(row){
                ...
                <tr style={{background:isCat?"#f0ede6":"#fff"}}>
                  <td style={{position:"sticky",left:0,zIndex:1,background:focusRow===row.id?"#fff8e1":isSel?"#e8f0fe":isCat?"#f0ede6":"#fff",padding:"3px 10px",borderBottom:"1px solid #f5f4f0",borderRight:"1.5px solid #e8e6df",boxShadow:focusRow===row.id?"inset 3px 0 0 #f57f17":"none"}}>
                    <div style={{display:"flex",alignItems:"center",gap:3}}>
                      ...
                      <input type="text" value={row.label||""} onChange={function(e){updRow(row.id,{label:e.target.value});}}
                        style={{flex:1,minWidth:0,border:"none",background:"transparent",fontSize:isCat?12:11,fontWeight:isCat?800:500,textTransform:isCat?"uppercase":"none",
                          color:rowDocs.length>0?"#1a73e8":isCat?"#555":"#333",textDecoration:rowDocs.length>0?"underline":"none",
                          padding:"2px 0",paddingLeft:isCat?0:12,outline:"none",fontFamily:"inherit",cursor:rowDocs.length>0?"pointer":"text"}}/>
        ...
        {showDocs&&<div className="sched-noprint" style={{position:"fixed",inset:0,zIndex:960,background:"rgba(0,0,0,.45)",display:"flex",alignItems:"center",justifyContent:"center",padding:16}}
          ...
          <div onClick={function(e){e.stopPropagation();}} style={{background:"#fff",borderRadius:14,padding:"20px 22px",width:640,maxWidth:"100%",maxHeight:"88vh",overflowY:"auto",boxShadow:"0 20px 60px rgba(0,0,0,.3)"}}>
            <div style={{fontFamily:"'DM Serif Display',serif",fontSize:18}}>📄 Reference documents</div>
            ...
            {canEdit&&<div style={{marginTop:16,paddingTop:14,borderTop:"1.5px solid #e8e6df"}}>
        ...
        {printOpts&&<div className="sched-noprint" style={{position:"fixed",inset:0,zIndex:960,background:"rgba(0,0,0,.45)",display:"flex",alignItems:"center",justifyContent:"center"}}
          ...
          <div onClick={function(e){e.stopPropagation();}} style={{background:"#fff",borderRadius:14,padding:"20px 22px",width:400,boxShadow:"0 20px 60px rgba(0,0,0,.3)"}}>
            <div style={{fontFamily:"'DM Serif Display',serif",fontSize:18,marginBottom:3}}>Print the schedule</div>
