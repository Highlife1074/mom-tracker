      ...
      <div style={{flex:1,minWidth:0}}>
        ...
        <div className="page-hdr" style={{marginBottom:12}}>
          <div style={{flex:1}}>
            ...
            <div className="titleblock accent">
              <div className="tb-main">
                <div className="tb-eyebrow">Tender · {td.package||"no package"}</div>
                ...
                <div className="tb-sub">{td.ownerTender||"no owner"}{td.contractor?" · "+td.contractor:""}</div>
              </div>
              <div className="tb-cells">
                {(function(){
                  var acc=(td.stepDates||{}).acc||{};
                  var ct=(td.stepDates||{}).contract||{};
                  var proc=(function(){try{return calcProcurement(td);}catch(e){return{};}})();
                  ...
                  return cells.map(function(c){
                    return <div className="tb-cell" key={c.k}>
