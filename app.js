...
.mom-head{display:flex;align-items:flex-start;gap:16px;border-bottom:3px solid var(--mom-blue);padding-bottom:12px;margin-bottom:16px}
.mom-head .t{flex:1}
...
function buildMomHtml(m){
  ...
  return '<style>'+MOM_CSS+'</style>'+
    '<div class="mom-head">'+
      ...
      '<div class="num"><b>'+esc(m.number||"—")+'</b><span>'+esc(fmtDate(m.date))+'</span></div>'+
    '</div>'+
    '<table class="hdr">'+
