...
function ScheduleView({curZone,schedules,saveSchedules,tasks,saveTasks,people,tags,zones,rooms,saveRooms,canEdit,roomBlockersOf,tenders,saveTenders,pkgOwners}){
  ...
  useEffect(function(){
    function measure(){
      ...
      if(!w)return;
      var need=w.scrollWidth>w.clientWidth+1?w.scrollWidth:0;   // 0 hides the mirror entirely
  ...
  return <div>
    ...
    {!sc
      ...
      :<div>
        ...
        <div className="sched-wrap" ref={wrapRef} onScroll={function(){syncScroll("wrap");}} style={{overflow:"auto",maxHeight:"62vh",border:"1px solid #e8e6df",borderRadius:"8px 8px 0 0",background:"#fff"}}>
        ...
        <div className="sched-noprint sched-mirror" ref={mirrorRef} onScroll={function(){syncScroll("mirror");}}
          style={{display:schedScrollW?"block":"none",position:"sticky",bottom:0,zIndex:60,overflowX:"auto",overflowY:"hidden",height:16,
            background:"#faf9f6",borderLeft:"1px solid #e8e6df",borderRight:"1px solid #e8e6df",
            borderBottom:"1px solid #e8e6df",borderRadius:"0 0 8px 8px",marginTop:-1}}>
