  ...
  return <div>
    ...
    {!sc
      ...
      :<div>
        ...
        {canEdit&&selRows.length>0&&<div className="sched-noprint" style={{padding:"8px 12px",background:"#e8f0fe",border:"1.5px solid #1a73e8",borderRadius:8,marginBottom:10,display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
            ...
            <thead>
              <tr>
                <th style={{position:"sticky",left:0,top:0,background:"#f5f4f0",zIndex:4,width:380,minWidth:380,maxWidth:380,textAlign:"left",padding:"6px 10px",borderBottom:"1.5px solid #e8e6df",fontSize:10,textTransform:"uppercase",color:"#888"}}>
                  {canEdit&&<input type="checkbox" className="sched-noprint" checked={selRows.length>0&&selRows.length===selectableIds.length}
                ...
                return <tr key={row.id} style={{background:isCat?"#f0ede6":"#fff"}}>
                  <td style={{position:"sticky",left:0,zIndex:1,background:isSel?"#e8f0fe":isCat?"#f0ede6":"#fff",padding:"3px 10px",borderBottom:"1px solid #f5f4f0",borderRight:"1.5px solid #e8e6df"}}>
                    <div style={{display:"flex",alignItems:"center",gap:3}}>
                      {canEdit&&!isCat&&<input type="checkbox" className="sched-noprint" checked={isSel}
                  ...
                  <td style={{padding:"3px 6px",borderBottom:"1px solid #f5f4f0",background:isCat?"#f0ede6":"#fff",whiteSpace:"nowrap"}}>
                    {isCat
                      ...
                      :canEdit
                        ...
                        :<span style={{fontSize:10,fontWeight:row.group?700:400,color:row.group?"#00695c":"#ddd"}}>{row.group||"—"}</span>}
                  </td>
